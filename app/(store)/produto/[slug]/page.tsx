      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="sticky top-24 space-y-4">
            <div className="relative aspect-square overflow-hidden rounded-[2.5rem] border border-border/40 bg-white shadow-app transition-all">
              ...
              <div className="absolute left-6 top-6 flex flex-col gap-2">
                {discount > 0 && (
                  <span className="rounded-full bg-[#F47920] px-4 py-1.5 text-xs font-bold text-white shadow-lg">
                    -{discount}%
                  </span>
                )}
                {product.is_new && (
                  <span className="rounded-full bg-emerald-500 px-4 py-1.5 text-xs font-bold text-white shadow-lg">NOVO</span>
                )}
              </div>
            </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div>
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-[#002D5B] leading-[1.1] mb-6">
              {product.name}
            </h1>
            ...
            <div className="space-y-1 mb-8">
              ...
              <div className="flex items-baseline gap-2">
                ...
                <p className="text-5xl font-bold text-[#002D5B] tracking-tighter">
          ...
          <div className="space-y-6">
            <div className="flex flex-col gap-2">
              <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Quantidade</label>
              <div className="flex items-center gap-4">
                <div className="flex items-center bg-muted/40 rounded-2xl p-1 border border-border/40">
                  ...
                  <span className="w-14 text-center font-bold text-lg text-[#002D5B]">{qty}</span>
                  <button 
            ...
            <div className="flex flex-col gap-3">
              <button
                ...
                className="flex h-16 w-full items-center justify-center gap-3 rounded-2xl bg-[#002D5B] text-lg font-bold text-white shadow-app transition-all hover:bg-[#003d7a] hover:scale-[1.02] active:scale-95 disabled:opacity-30"
              >
              ...
              <a
                ...
                className="flex h-16 w-full items-center justify-center gap-3 rounded-2xl border-2 border-emerald-500/20 bg-emerald-50 text-lg font-bold text-emerald-700 transition-all hover:bg-emerald-100 hover:border-emerald-500/40 active:scale-95"
              >
      ...
      <div className="mt-20 lg:mt-24">
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-16">
          <div className="lg:col-span-7 space-y-12">
            {product.description && (
              <section>
                <h2 className="text-2xl font-bold text-[#002D5B] mb-6 flex items-center gap-3">
            ...
            <section>
              <div className="flex items-center justify-between mb-8">
                <h2 className="text-2xl font-bold text-[#002D5B] flex items-center gap-3">
                  <div className="w-2 h-8 bg-[#F47920] rounded-full" />
                  Avaliações
                </h2>
                {reviews && reviews.length > 0 && (
              ...
              <div className="bg-[#002D5B] rounded-[2rem] p-8 text-white mb-10 flex flex-col md:flex-row items-center gap-10">
                <div className="text-center md:border-r md:border-white/10 md:pr-10">
                  <p className="text-7xl font-bold leading-none mb-2">{avgRating}</p>
                  ...
                  reviews.map((r: any) => (
                    <div key={r.id} className="p-6 rounded-[1.5rem] border border-border/40 bg-white hover:border-primary/20 transition-all shadow-sm">
                      <div className="flex items-center gap-4 mb-4">
                        <div className="w-12 h-12 rounded-2xl bg-muted flex items-center justify-center text-[#002D5B] font-bold text-lg">
                          {(r.customer_name || "C").charAt(0).toUpperCase()}
                        </div>
                        <div>
                          <p className="font-bold text-foreground">{r.customer_name || "Cliente Verificado"}</p>
                          <div className="flex items-center gap-0.5">
                            {Array.from({ length: 5 }).map((_, i) => (
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-24 bg-muted/30 rounded-[2.5rem] p-8 border border-border/40">
              <h3 className="text-xl font-bold text-[#002D5B] mb-2">Deixe sua opinião</h3>
              ...
              <div className="space-y-6">
                <div>
                  <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1 mb-2 block">Nome Completo</label>
                  <input 
                ...
                <div>
                  <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1 mb-2 block">Sua Nota</label>
                ...
                <div>
                  <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1 mb-2 block">Comentário</label>
                  <textarea 
                ...
                <button 
                  ...
                  className="w-full h-16 bg-[#F47920] text-white rounded-2xl font-bold text-lg shadow-lg hover:bg-[#e06b10] hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50"
                >
